...
const MOCK_PRODUCTS = [
  ...
  // --- Chocolate ---
  { id: "ch-1", name: "Dark Belgian Box", price: 15000, category: "Chocolate", status: "New Arrivals", img: "/images/Img/Chocolate/download (1).png" },
  { id: "ch-2", name: "Dark Belgian Box", price: 15000, category: "Chocolate", status: "New Arrivals", img: "/images/Img/Chocolate/download (2).png" },
  { id: "ch-3", name: "Dark Belgian Box", price: 15000, category: "Chocolate", status: "New Arrivals", img: "/images/Img/Chocolate/download (3).png" },
  { id: "ch-4", name: "Dark Belgian Box", price: 15000, category: "Chocolate", status: "New Arrivals", img: "/images/Img/Chocolate/download (6).png" },
  { id: "ch-5", name: "Dark Belgian Box", price: 15000, category: "Chocolate", status: "New Arrivals", img: "/images/Img/Chocolate/download (5).png" },
];
